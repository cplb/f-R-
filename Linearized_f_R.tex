...
We can also use the epicyclic frequencies for the classic test of planetary precession in the solar system. Unless $\omega_0 = \Omega$ the epicyclic motion will be asynchronous with the orbital motion. We see that this is the case for radial motion: there will be precession of the periapsis. In one revolution the ellipse will precess about the focus by
\begin{eqnarray}
...
We also used the epicyclic frequencies to consider the bounds that could be placed by measuring the phase of a gravitational waveform. We estimate that deviations would only be detectable $|a_2| \gtrsim 10^{17}\units{m^2}$, assuming an extreme mass-ratio binary with a massive black hole of mass $\sim 10^6 M_odot$. The limit of detectability will depend upon the black hole mass, orbital radius and observational time, but it is clear that if the laboratory bound is universal there should be no detectable deviation: observation of a deviation would thus prove that $a_2$ varied with environment.
